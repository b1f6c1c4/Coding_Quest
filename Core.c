...
static IIR_t m_IIR[1] = {
    {
        // Numer
        {
            _IQ30(-1.302658194482643),
            _IQ30(1)
        },
        // Denom
        {
            _IQ30(-1.875840903751426),
            _IQ30(0.883170659440711)
        },
        _IQ30(0.010510994223052), // Gain
        0, // Node1
        0  // Node2
    },
};
...
_iq20 CurrentController()
{
    ...
    // Ratio
    m_DCvoltage = IIR_RunN(m_IIR, 1, g_DCvoltage);
    dcV = m_DCvoltage;
    if (dcV < MIN_DC_VOLT)
        dcV = MIN_DC_VOLT;
